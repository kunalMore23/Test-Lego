...
void Reader::read(std::string inFilePath, std::vector<Triangle>& inTriangles, float side)
{
...
void Reader::read(std::string inFilePath, std::vector<Triangle>& inTriangles)
{
    std::ifstream dataFile;
    dataFile.open(inFilePath);
    if (!dataFile.is_open())
